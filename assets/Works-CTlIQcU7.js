import{a as e,d as t,s as n,t as r}from"./index-COBtfL5P.js";var i=t(n(),1),a=r(),o=[{slug:`co2table`,name:`CO₂ Table`,date:`2026.09`,dateLabel:`2026 年 9 月`,url:`https://co2table.com`,images:[`/assets/works/co2table-setup.jpg`,`/assets/works/co2table-prep.jpg`,`/assets/works/co2table-hold.jpg`,`/assets/works/co2table-hold2.jpg`,`/assets/works/co2table-about.jpg`],summary:`自由潛水乾式訓練計時器。`,description:`設定 CO₂ / O₂ 耐受表，跑計時、記錄成績。`,role:`設計與開發`},{slug:`truve`,name:`Truve`,date:`2026.08`,dateLabel:`2026 年 8 月`,url:`https://truve-news.vercel.app/`,images:[`/assets/works/truve.jpg`],summary:`Community-driven fact-checking and news reputation platform.`,description:`Anyone can open a fact-check, attach evidence with a source URL, and vote. Each contributor carries a reputation score that weights their input.`,role:`設計與開發`}],s=()=>(0,a.jsx)(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2.5`,strokeLinecap:`round`,strokeLinejoin:`round`,"aria-hidden":`true`,children:(0,a.jsx)(`path`,{d:`M7 17 17 7M8 7h9v9`})});function c(e){let t=[];for(let n of e){let e=n.date.slice(0,4),r=t[t.length-1];r&&r.year===e?r.items.push(n):t.push({year:e,items:[n]})}return t}var l=({images:e,name:t})=>{let n=(0,i.useRef)(null),[r,o]=(0,i.useState)(0);if(e.length<2)return(0,a.jsx)(`div`,{className:`w-shots`,children:(0,a.jsx)(`div`,{className:`w-slide`,style:{"--slide-img":`url("${e[0]}")`},children:(0,a.jsx)(`img`,{src:e[0],alt:`${t} 截圖`,loading:`lazy`})})});let s=t=>{let r=n.current;if(!r)return;let i=Math.max(0,Math.min(e.length-1,t));r.scrollTo({left:i*r.clientWidth,behavior:`smooth`})},c=e=>{let t=n.current;t&&s(Math.round(t.scrollLeft/t.clientWidth)+e)};return(0,a.jsxs)(`div`,{className:`w-shots is-carousel`,children:[(0,a.jsx)(`div`,{className:`w-track`,ref:n,onScroll:()=>{let e=n.current;e&&o(Math.round(e.scrollLeft/e.clientWidth))},children:e.map((e,n)=>(0,a.jsx)(`div`,{className:`w-slide`,style:{"--slide-img":`url("${e}")`},children:(0,a.jsx)(`img`,{src:e,alt:`${t} 截圖 ${n+1}`,loading:`lazy`,draggable:!1})},e))}),(0,a.jsx)(`button`,{className:`w-nav w-prev`,"aria-label":`上一張`,onClick:()=>c(-1),disabled:r===0,children:`‹`}),(0,a.jsx)(`button`,{className:`w-nav w-next`,"aria-label":`下一張`,onClick:()=>c(1),disabled:r===e.length-1,children:`›`}),(0,a.jsx)(`div`,{className:`w-dots`,children:e.map((t,n)=>(0,a.jsx)(`button`,{className:n===r?`on`:``,"aria-label":`第 ${n+1} 張，共 ${e.length} 張`,"aria-current":n===r,onClick:()=>s(n)},n))})]})},u=()=>{let t=(0,i.useRef)(null);(0,i.useEffect)(()=>{let e=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,n=t.current?.querySelectorAll(`.w-entry`);if(!n)return;if(e||!(`IntersectionObserver`in window)){n.forEach(e=>e.classList.add(`is-in`));return}let r=new IntersectionObserver(e=>{for(let t of e)t.isIntersecting&&(t.target.classList.add(`is-in`),r.unobserve(t.target))},{rootMargin:`0px 0px -12% 0px`});return n.forEach(e=>r.observe(e)),()=>r.disconnect()},[]);let n=c(o);return(0,a.jsxs)(`div`,{className:`w-root`,ref:t,children:[(0,a.jsxs)(e,{children:[(0,a.jsx)(`title`,{children:`adi | 作品集`}),(0,a.jsx)(`meta`,{name:`description`,content:`adi 的作品 — 每個月開發一個 app。`}),(0,a.jsx)(`link`,{rel:`preconnect`,href:`https://fonts.googleapis.com`}),(0,a.jsx)(`link`,{rel:`preconnect`,href:`https://fonts.gstatic.com`,crossOrigin:`anonymous`}),(0,a.jsx)(`link`,{href:`https://fonts.googleapis.com/css2?family=Archivo:wght@400;500;600&family=Space+Grotesk:wght@400;500;600;700&display=swap`,rel:`stylesheet`})]}),(0,a.jsxs)(`div`,{className:`w-wrap`,children:[(0,a.jsx)(`a`,{href:`#/`,className:`w-back`,children:`← 回桌面`}),(0,a.jsxs)(`header`,{className:`w-hero`,children:[(0,a.jsx)(`p`,{className:`w-kicker`,children:`作品集 · WORKS`}),(0,a.jsxs)(`h1`,{className:`w-title`,children:[`每個月，`,(0,a.jsx)(`br`,{}),`開發`,(0,a.jsx)(`span`,{children:`一個 app`}),`。`]})]}),(0,a.jsxs)(`div`,{className:`w-timeline`,children:[n.map(e=>(0,a.jsxs)(`section`,{className:`w-yeargroup`,children:[(0,a.jsx)(`div`,{className:`w-year`,"aria-hidden":`true`,children:e.year}),(0,a.jsx)(`ol`,{className:`w-list`,children:e.items.map(e=>(0,a.jsxs)(`li`,{className:`w-entry`,children:[(0,a.jsxs)(`div`,{className:`w-when`,children:[(0,a.jsx)(`span`,{className:`w-dot`,"aria-hidden":`true`}),(0,a.jsx)(`time`,{dateTime:e.date.replace(`.`,`-`),children:e.dateLabel})]}),(0,a.jsxs)(`article`,{className:`w-card`,children:[(0,a.jsx)(l,{images:e.images,name:e.name}),(0,a.jsxs)(`div`,{className:`w-card-body`,children:[(0,a.jsx)(`h2`,{className:`w-name`,children:(0,a.jsx)(`a`,{href:e.url,target:`_blank`,rel:`noreferrer`,children:e.name})}),(0,a.jsx)(`p`,{className:`w-summary`,children:e.summary}),(0,a.jsx)(`p`,{className:`w-desc`,children:e.description}),(0,a.jsxs)(`div`,{className:`w-meta`,children:[(0,a.jsx)(`span`,{children:e.role}),(0,a.jsxs)(`a`,{className:`w-visit`,href:e.url,target:`_blank`,rel:`noreferrer`,children:[`查看網站 `,(0,a.jsx)(s,{})]})]})]})]})]},e.slug))})]},e.year)),(0,a.jsxs)(`div`,{className:`w-end`,"aria-hidden":`true`,children:[(0,a.jsx)(`span`,{className:`w-dot`}),(0,a.jsx)(`span`,{children:`持續更新中`})]})]})]}),(0,a.jsx)(`style`,{children:`
        .w-root{
      ...
      `})]})};export{u as Works,u as default};